...
public class Basket {
    ...
    // The number of products in the basket. "Lazy Calculation" on the first access. Reset on basket change.
    private Integer numberOfProductsInBasket = null;
    ...
    public int getNumberOfProductsInBasket() {
        if (numberOfProductsInBasket == null) {
            numberOfProductsInBasket = 0;
            for (ProductInBasket currProductInBasket : productsInBasketSorted) {
                numberOfProductsInBasket += currProductInBasket.quantity;
            }
        }
